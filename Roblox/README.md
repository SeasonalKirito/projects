...
```lua
getgenv().FILE = "" -- This is the name of the file. Make sure to have .txt or .lua at the end or it may not work ONLY USE LETTERS NO SYMBOLS OR THE SCRIPT WILL BREAK, periods are an end type statement
